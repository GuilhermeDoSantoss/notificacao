package com.guilhermesantos.notificacao.business;

import com.guilhermesantos.notificacao.business.DTO.TarefasDTO;
import com.guilhermesantos.notificacao.infrasctructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto) {
        try {
            ...
            context.setVariable("datEvento", dto.getDataEvento());
